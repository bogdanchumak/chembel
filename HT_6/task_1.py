...
cars_traffic_light = ['Red', 'Red', 'Red', 'Red', 'Yellow', 'Yellow', 'Green', 'Green', 'Green', 'Green', 'Yellow', 'Yellow']

pedestrian_traffic_light = ['Green', 'Green', 'Green', 'Green', 'Green', 'Green', 'Red', 'Red', 'Red', 'Red', 'Red', 'Red']

while True:
    for i, j in zip(cars_traffic_light, pedestrian_traffic_light):
        print(i, '      ', j)
        time.sleep(1)